...
using Tyuiu.SavitskyDA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.SavitskyDA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Савицкий Д. А. | АСОиУб-23-1";
